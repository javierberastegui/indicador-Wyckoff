...
La v2.5.0 mantiene alertas JSON desde TradingView para señales candidatas LONG/SHORT. No se añaden alertas independientes para fractalidad, EMA50 ni manos fuertes; esos datos viajan como payload dentro de `signal.long_candidate` y `signal.short_candidate`.
...
- No ejecutar señales overlay v2.5.0 como si fueran resultados de estrategia v2.2 sin documentar la diferencia.
...
## Campos JSON añadidos en v2.5.0
- `fractal_sync`
- `fractal_w`
- `fractal_d`
- `fractal_1h`
