...
## Estado operativo
Documentación viva aplicada y versión funcional v2.3.0 preparada en rama de trabajo con mejora visual del indicador overlay y del helper RSI, sin cambios en la estrategia ni en el runner ATR manual.

## Arquitectura viva actual
- indicador Wyckoff + EMA + RSI en Pine Script con overlay visual v2.3.0
...
- validación/backtesting pendiente en TradingView; gestión de riesgo v2.2 y visual v2.3 pendientes de compilación en plataforma
...
- La v2.3.0 solo reorganiza la lectura visual: cruces EMA, retrocesos, zonas Wyckoff, soporte/resistencia opcional, divergencias/absorciones y panel RSI separado no añaden alertas nuevas ni cambian entradas/salidas.

## Pendiente inmediato
1. Compilar `indicador_wyckoff_ema_rsi_v2.pine` en TradingView y revisar jerarquía visual v2.3.0.
